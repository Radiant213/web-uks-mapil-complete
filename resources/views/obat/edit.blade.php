...
<div class="mb-6 flex items-center gap-4 animate-fadeInUp">
    ...
    <div>
        <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Edit Data Obat</h1>
        <p class="text-sm text-gray-500 mt-1">Ubah nama atau jumlah stok obat.</p>
    </div>
</div>

<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-2xl animate-fadeInUp anim-delay-2">
    <form action="{{ route('obat.update', $obat->id) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nama_obat" value="{{ $obat->nama_obat }}" required placeholder="Contoh: Paracetamol 500mg" 
            ...
            <div>
                ...
                <div class="relative">
                    <select name="satuan" required class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all outline-none text-slate-700 appearance-none">
                        ...
                        <option value="Sirup" {{ $obat->satuan == 'Sirup' ? 'selected' : '' }}>Sirup</option>
            ...
            <div>
                ...
                <input type="number" name="stok" value="{{ $obat->stok }}" required min="0" placeholder="0" 
        ...
        <div class="pt-4 flex justify-end gap-3 border-t border-gray-100">
            ...
            <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 shadow-sm shadow-indigo-200 transition-colors btn-animate">Update Obat</button>
        </div>
    </form>
</div>
@endsection
