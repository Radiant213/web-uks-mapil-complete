...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-2xl">
    <form action="{{ route('obat.update', $obat->id) }}" method="POST" class="space-y-6">
        ...
        <div class="pt-4 flex justify-end gap-3 border-t border-gray-100">
            ...
            <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 shadow-sm shadow-indigo-200 transition-colors">Update Obat</button>
        </div>
    </form>
</div>
@endsection
