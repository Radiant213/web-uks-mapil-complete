...
<div class="mb-6 flex items-center gap-4 animate-fadeInUp">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Masukkan data lengkap siswa ke dalam sistem.</p>
    </div>
</div>
    ...
    <form action="{{ route('siswa.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="nis" required placeholder="Contoh: 100234" 
        ...
        <div class="pt-4 flex justify-end gap-3 border-t border-gray-100">
            ...
            <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 shadow-sm shadow-indigo-200 transition-colors btn-animate">Simpan Data Siswa</button>
        </div>
    </form>
</div>
@endsection
